"""Publication-quality style configuration for occupancy detection plots.
...
# ---------------------------------------------------------------------------
# Colorblind-friendly palette for empty/occupied
# ---------------------------------------------------------------------------
CLASS_COLORS: dict[int, str] = {
    0: "#009E73",  # Green — Empty
    1: "#CC3311",  # Red   — Occupied
}
...
# Accent color for reference lines, EER markers
